...
let screenshotGameStates = 
    ...
    (@"in-game\example_screenshot_1.jpg", {
        ...
        playGrid = { slots = (array2D [ [ pc [1;7;6;4] Op 0; emptySlot; emptySlotElem e ]
    ...
    (@"in-game\example_screenshot_3.jpg", {
        ...
        playGrid = { slots = (array2D [ [ pc [6;5;8;4] Op -1; emptySlotElem h; emptySlot          ]
...
let targetSelectionGameStates =
    let baseGameState = {
            ...
            playGrid = { slots = (array2D [ [ emptySlotElem h; emptySlot; emptySlot ]
                                            [ emptySlot      ; emptySlot; emptySlot ]
                                            [ emptySlot      ; emptySlot; emptySlot ] ])}
        }
    [ for y in 0..2 do
