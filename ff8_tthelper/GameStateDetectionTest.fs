...
let screenshotGameStates = 
    ...
    (@"in-game\example_screenshot_1.jpg", {
        ...
        playGrid = { slots = [| pc [1;7;6;4] Op 0; emptySlot; emptySlotElem e
    ...
    (@"in-game\example_screenshot_2.jpg", {
        ...
        playGrid = { slots = [| pc [5;4;5;7] Op -1; pc [1;7;8;7] Me 0; pc [1;7;6;4] Op 0 
    ...
    (@"in-game\example_screenshot_3.jpg", {
        ...
        playGrid = { slots = [| pc [6;5;8;4] Op -1; emptySlotElem h; emptySlot          
    ...
    (@"in-game\elemental_-1_in_0_1.jpg", {
        ...
        playGrid = { slots = [| pc [4;6;5;5] Op  0; emptySlot; pc [5;9;1;9] Me 0
...
let targetSelectionGameStates =
    let baseGameState = {
            ...
            playGrid = { slots = [| emptySlotElem h; emptySlot; emptySlot 
                                    emptySlot      ; emptySlot; emptySlot 
                                    emptySlot      ; emptySlot; emptySlot |] }
        }
    [ for y in 0..2 do
