      ...
      before =
        { turnPhase = MyCardSelection 0
          ...
          playGrid = PlayGrid([| pc [1;7;6;4] Op 0; emptySlot;         emptySlotElem e
                                 ...
                                 emptySlot;         emptySlot;         emptySlot       |])}
      rules = { isSame = false; isPlus = false }; move = (0,1)
      after =
    ...
    { comment = "same rule triggered on 2/3 neighbors"
      before =
        { turnPhase = MyCardSelection 4
          myHand = [|None; None; None; None; hc [2;5;5;2] Me e|]
          opHand = [|None; None; None; None; hc [1;5;3;3] Op n|]
          playGrid = PlayGrid([| pc [5;4;5;7] Op -1; pc  [1;7;8;7] Me 0; pc [1;7;6;4] Op 0
                                 pc [7;8;7;2] Op  0; pc  [4;7;6;2] Op 0; pc [5;9;1;9] Me 0
                                 pc [8;4;8;5] Op  0; emptySlot;          pc [9;8;6;2] Op 0 |]) }
      rules = { isSame = true; isPlus = false }; move = (4,7)
      after =
        { turnPhase = OpponentsTurn
          ...
          playGrid = PlayGrid([| pc [5;4;5;7] Op -1; pc  [1;7;8;7] Me 0  ; pc [1;7;6;4] Op 0
                                 pc [7;8;7;2] Op  0; pc  [4;7;6;2] Op 0  ; pc [5;9;1;9] Me 0
                                 pc [8;4;8;5] Op  0; pce [2;5;5;2] Me 0 e; pc [9;8;6;2] Op 0 |]) }
    }
]

let executeMoveWorksCorrectly (data: ExecuteMoveTestData): unit =
    let newGameState = executeMove data.before data.move
